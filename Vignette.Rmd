...
estimatedSurvHazard <- estimateSimulationParams(outcome=outcome, time=time, treatment=treatment, covariates=covariates, 
                                                covId=NULL, hazEstimate="survival", hazMethod=hazMethod, seed=2010)
...
observedEvent <- simData$ObservedEvent
observedTime <- simData$ObservedTime
...
estimatedSurvHazard_sim <- estimateSimulationParams(outcome=outcome, time=time, treatment=treatment, covariates=covariates,
                                                    simOutcome=observedEvent, simTime=observedTime, 
...
### risk difference
```{r}
tmle_S <- estimateCounterfactSurvival(treatment=treatment, outcome=observedEvent, time=observedTime,
...
aipw_S <- estimateCounterfactSurvival(treatment=treatment, outcome=observedEvent, time=observedTime,
                                      survHaz=estimatedSurvHazard_sim$haz, cenHaz=estimatedCenHazard_sim$haz, treatProb=treatProb,
                                      coarsenedTime=estimatedSurvHazard$coarsenedData, 
                                      estimand="risk", method="AIPW")

ipw_S <- estimateCounterfactSurvival(treatment=treatment, outcome=observedEvent, time=observedTime,
...
cox <- estimateCounterfactSurvival(treatment=treatment, outcome=observedEvent, time=observedTime,
                                     survHaz=estimatedSurvHazard_sim$haz, cenHaz=estimatedCenHazard_sim$haz, 
                                     treatProb=treatProb, coarsenedTime=estimatedSurvHazard$coarsenedData, 
                                     estimand="risk", method="cox", hazMethod=hazMethod)

weightedCox <- estimateCounterfactSurvival(treatment=treatment, outcome=observedEvent, time=observedTime,
                                      survHaz=estimatedSurvHazard_sim$haz, cenHaz=estimatedCenHazard_sim$haz, treatProb=treatProb,
                                      coarsenedTime=estimatedSurvHazard$coarsenedData, 
