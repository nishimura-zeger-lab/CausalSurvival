...
```{r}
censoring_time <- 6 + simCenTime(treatment=treatment, covariates=covariates, lambda1=0.000003, nu1=1.5, lambda0=0.000003, nu0=1.5, seed=2019)
...
estimatedSurvHazard <- estimateSimulationParams(outcome=outcome, time=time, treatment=treatment, covariates=covariates, 
                                                covId=1:max(covariates$covariateId), hazEstimate="survival", hazMethod=hazMethod, seed=2010)
estimatedCenHazard <- estimateSimulationParams(outcome=outcome, time=time, treatment=treatment, covariates=covariates,
                                               covId=1:max(covariates$covariateId), hazEstimate="censoring", hazMethod=hazMethod, seed=2019)
```
...
### risk difference
```{r}
tmle_S <- estimateCounterfactSurvival(treatment=treatment, outcome=SimData$ObservedEvent, time=SimData$ObservedTime,
                                      ...
                                      estimand="risk", method="TMLE")

aipw_S <- estimateCounterfactSurvival(treatment=treatment, outcome=SimData$ObservedEvent, time=SimData$ObservedTime,
                                      survHaz=estimatedSurvHazard_sim$haz, cenHaz=estimatedCenHazard_sim$haz, treatProb=treatProb,
                                      coarsenedTime=estimatedSurvHazard$coarsenedData, 
                                      estimand="risk", method="AIPW")

ipw_S <- estimateCounterfactSurvival(treatment=treatment, outcome=SimData$ObservedEvent, time=SimData$ObservedTime,
                                     survHaz=estimatedSurvHazard_sim$haz, cenHaz=estimatedCenHazard_sim$haz, 
                                     treatProb=treatProb, coarsenedTime=estimatedSurvHazard$coarsenedData, 
                                     estimand="risk", method="IPW")

cox_S <- estimateCounterfactSurvival(treatment=treatment, outcome=SimData$ObservedEvent, time=SimData$ObservedTime,
                                     survHaz=estimatedSurvHazard_sim$haz, cenHaz=estimatedCenHazard_sim$haz, 
                                     treatProb=treatProb, coarsenedTime=estimatedSurvHazard$coarsenedData, 
                                     estimand="risk", method="cox", hazMethod=hazMethod)

weightedCox_S <- estimateCounterfactSurvival(treatment=treatment, outcome=SimData$ObservedEvent, time=SimData$ObservedTime,
                                      survHaz=estimatedSurvHazard_sim$haz, cenHaz=estimatedCenHazard_sim$haz, treatProb=treatProb,
                                      coarsenedTime=estimatedSurvHazard$coarsenedData, 
                                      estimand="risk", method="weightedCox", hazMethod=hazMethod)
...
### difference in RMST
```{r}
tmle_rmst <- estimateCounterfactSurvival(treatment=treatment, outcome=SimData$ObservedEvent, time=SimData$ObservedTime,
                                         survHaz=estimatedSurvHazard_sim$haz, 
                                         cenHaz=estimatedCenHazard_sim$haz, treatProb=treatProb,
                                         coarsenedTime=estimatedSurvHazard$coarsenedData, 
                                         estimand="rmst", method="TMLE")

aipw_rmst <- estimateCounterfactSurvival(treatment=treatment, outcome=SimData$ObservedEvent, time=SimData$ObservedTime,
                                         survHaz=estimatedSurvHazard_sim$haz, 
                                         cenHaz=estimatedCenHazard_sim$haz, treatProb=treatProb,
                                         coarsenedTime=estimatedSurvHazard$coarsenedData, 
                                         estimand="rmst", method="AIPW")

ipw_rmst <- estimateCounterfactSurvival(treatment=treatment, outcome=SimData$ObservedEvent, time=SimData$ObservedTime,
                                        survHaz=estimatedSurvHazard_sim$haz, 
                                        cenHaz=estimatedCenHazard_sim$haz, treatProb=treatProb,
                                        coarsenedTime=estimatedSurvHazard$coarsenedData, 
                                        estimand="rmst", method="IPW")

cox_rmst <- estimateCounterfactSurvival(treatment=treatment, outcome=SimData$ObservedEvent, time=SimData$ObservedTime,
                                        survHaz=estimatedSurvHazard_sim$haz, 
                                        cenHaz=estimatedCenHazard_sim$haz, treatProb=treatProb,
                                        coarsenedTime=estimatedSurvHazard$coarsenedData, 
                                        estimand="rmst", method="cox", hazMethod=hazMethod)

weightedCox_rmst <- estimateCounterfactSurvival(treatment=treatment, outcome=SimData$ObservedEvent, time=SimData$ObservedTime,
                                                survHaz=estimatedSurvHazard_sim$haz, 
                                                cenHaz=estimatedCenHazard_sim$haz, treatProb=treatProb,
                                                coarsenedTime=estimatedSurvHazard$coarsenedData, 
                                                estimand="rmst", method="weightedCox", hazMethod=hazMethod)
